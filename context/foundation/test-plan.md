...
|---|---|---|---|---|---|---|
| 1 | Critical-path collision & invariant coverage | Prove the collision/defer chain and single-active-check-in invariant hold under 3+ meals and concurrent requests | #1, #2 | unit + integration (bootstraps the runner) | change opened | `context/changes/testing-collision-invariant-coverage/` |
...
- TBD — see §3 Phase 1 (quiet-hours suppression logic, once Phase 3 lands, is the first natural unit-test candidate; Phase 1 will set the convention).

### 6.2 Adding an integration test

- TBD — see §3 Phase 1 (collision/defer chain and single-active-check-in invariant).

### 6.3 Adding an e2e test

- TBD — see §3 Phase 1 (only if the collision/defer flow's failure mode is judged to require the full deployed shape).
